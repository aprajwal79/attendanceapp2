...
//                openNewScreen();
        ...
        public boolean permission() {
            if (SDK_INT >= Build.VERSION_CODES.R) {
                ...
                return write == PackageManager.PERMISSION_GRANTED && read == PackageManager.PERMISSION_GRANTED && phoneState == PackageManager.PERMISSION_GRANTED;
            }
        }
        ...
        public void RequestPermission_Dialog() {
            if (SDK_INT >= Build.VERSION_CODES.R) {
                ...
                ActivityCompat.requestPermissions(ActivationActivity.this, new String[]{WRITE_EXTERNAL_STORAGE, READ_EXTERNAL_STORAGE, READ_PHONE_STATE}, REQUEST_CODE);
            }
        }
