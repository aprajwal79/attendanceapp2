...
public class FaceRectTransformer {
    ...
    private LensPosition cameraId;

    public FaceRectTransformer(int previewWidth, int previewHeight, int canvasWidth,
                               int canvasHeight, int cameraDisplayOrientation, LensPosition cameraId,
    ...
    public Rect adjustRect(Rect ftRect) {
        ...
        LensPosition cameraId = this.cameraId;
    ...
    public void setCameraId(LensPosition cameraId) {
        this.cameraId = cameraId;
    }
    ...
    public LensPosition getCameraId() {
        return cameraId;
    }
